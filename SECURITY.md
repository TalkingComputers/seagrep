...
Use a [private GitHub security advisory](https://github.com/TalkingComputers/seagrep/security/advisories/new) for this repository. If that is unavailable, contact a maintainer privately and share only a short non-sensitive summary until a private channel is established.
...
```console
$ gh attestation verify <downloaded-archive> -R TalkingComputers/seagrep
```
